<x-layout>
    <div class="w-[500px] flex flex-col justify-center bg-white p-[40px] rounded-2xl shadow-lg">
        <div class="flex justify-between items-center mb-6">
            ...
            <button type="submit" class="py-2 px-4 rounded-xl bg-gray-100 hover:bg-gray-50 font-semibold text-red-400">
            ...
            <form action="/todos/{{$todo->id}}" method="post">
                ...
                <div class="flex mb-4">
                    <input id="todo" name="todo" type="text" placeholder="Edit your todo" required
                           class=" p-4 rounded-xl focus-visible:outline-0 flex-1 bg-gray-50 border-gray-200 border" value="{{$todo->title}}">
